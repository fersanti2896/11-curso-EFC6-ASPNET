...
namespace PeliculasWebAPI.Migrations {
    public partial class FuncionesDefinidasPorUser : Migration {
        protected override void Up(MigrationBuilder migrationBuilder) {
            migrationBuilder.Sql(@"CREATE FUNCTION FacturaDetalleSuma ( @FacturaId INT )
                                   RETURNS int
                                   AS
                                   BEGIN
            ...
            migrationBuilder.Sql(@"CREATE FUNCTION FacturaDetallePromedio ( @FacturaId INT )
