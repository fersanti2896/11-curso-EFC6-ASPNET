    ...
    public partial class DatosPrueba : Migration {
        protected override void Up(MigrationBuilder migrationBuilder) {
            migrationBuilder.InsertData(
                table  : "Actores",
                columns: new[] { "Id", "Biografia", "FechaNac", "Nombre" },
                values : new object[,] {
            ...
            migrationBuilder.InsertData(
                table  : "Peliculas",
                columns: new[] { "Id", "Cartelera", "FechaEstreno", "PosterURL", "Titulo" },
                values : new object[,] {
                    ...
                    { 5, true, new DateTime(2022, 5, 3, 0, 0, 0, 0, DateTimeKind.Local), "https://upload.wikimedia.org/wikipedia/en/5/50/The_Matrix_Resurrections.jpg", "The Matrix Resurrections" }
                }
            );

            migrationBuilder.InsertData(
                table  : "CinesOfertas",
                columns: new[] { "Id", "CineId", "DescuentoPorcentaje", "FechaFin", "FechaInicio" },
                values : new object[,] {
                    { 1, 1, 10m, new DateTime(2022, 5, 10, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 5, 3, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 4, 15m, new DateTime(2022, 5, 8, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 5, 3, 0, 0, 0, 0, DateTimeKind.Local) }
                }
            );
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PeliculasId", "SalasCinesId" },
                values : new object[,] {
                    { 5, 1 },
                    { 5, 2 },
                    { 5, 3 },
        ...
        protected override void Down(MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.DeleteData(
                table     : "PeliculaSalaCine",
                keyColumns: new[] { "PeliculasId", "SalasCinesId" },
